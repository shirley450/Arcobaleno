 ...
 var erorr_num = 0;
  ...
  for (var j = 0; j < abr_list.length; j++) {
    ...
    for (var i = 0; i < blk_list.length - 1; i++) {
      var dict = new Array();
      if(dict[blk_list[i]] !== 1) {
        dict[blk_list[i]] = 1;
      } else {
      //for (var w = i + 1; w < blk_list.length; w++) {
        //if (blk_list[i] == blk_list[w]) {
          complie_info +="Error:" + blk_list[i] + " can not be put several times at the list!"+"\n";
          erorr_num++;
  ...
  for (var j = 0; j < abr_list.length; j++) {
    ...
    if (temp_type_name == "4") {
      complie_info +="Error:" + abr_blk_list[0].split("ID")[0] + " can not be put at the top of the list!"+"\n";
      erorr_num++;
      ...
      if ((find == 0 && temp_type_name == "3") || (find == 0 && temp_type_name == "7") || (find == 0 && temp_type_name == "5")) {
        ...
        complie_info +="Error:" + abr_blk_list[0] + " can not be put on the top of the list!"+"\n";
        erorr_num++;
      }
    }
  }
  ...
  for (var j = 0; j < abr_list.length; j++) {
    ...
    for (var i = 1; i < abr_blk_list.length - 1; i++) {
      ...
      if (temp_type_name != "2" && temp_type_name != "3" && temp_type_name != "7" && temp_type_name != "6") {
        complie_info +="Error:" + abr_blk_list[i] + " can not be put at the middle of the list!"+"\n";
        erorr_num++;
      }
    }
  }
  ...
  for (var j = 0; j < abr_list.length; j++) {
    ...
    if (temp_type_name == "4") {
      ...
      complie_info +="Error:" + abr_blk_list[abr_blk_list.length - 1] + " can not be put at the bottom of the list!"+"\n";
      erorr_num++;
    }
  }
  return erorr_num;
  ...
  for (var j = and_begin; j <= and_end; j++) {
    ...
    } else if (temp_type_name == "2" || temp_type_name == "6" || temp_type_name == "3" || temp_type_name == "5" || temp_type_name == "7") //and组件里含有源组件的属性的组件类型1,3,5,7，需要查找的是2、6
    {
      ...
      if ((find == 0 && temp_type_name == "2") || (find == 0 && temp_type_name == "6")) {
        complie_info +="Error: 6 " + notimeout_list[list_ind].blklist[j] + " can not be put on the top of the list!"+"\n";
        erorr_num++;
      } else if (find == 1) {
        find = 0;
      ...
      complie_info +="Error: 7 " + notimeout_list[list_ind].blklist[j] + " can not be put on the top of the list!"+"\n";
      erorr_num++;
    }
  }
  return erorr_num;
...
function check_or(blkname, list_ind) {
  ...
  for (var j = or_begin; j <= or_end; j++) {
    ...
    } else if (temp_type_name == "2" || temp_type_name == "6" || temp_type_name == "3" || temp_type_name == "5" || temp_type_name == "7") //and组件里含有源组件的属性的组件类型1,3,5,7，需要查找的是2、6
    {
      ...
      if ((find == 0 && temp_type_name == "2") || (find == 0 && temp_type_name == "6")) {
        complie_info +="Error: 8 " + notimeout_list[list_ind].blklist[j] + " can not be put on the top of the list!"+"\n";
        erorr_num++;
      } else if (find == 1) {
        find = 0;
      } else if ((find == 0 && temp_type_name == "3") || (find == 0 && temp_type_name == "5") || (find == 0 && temp_type_name == "7")) {
      ...
      complie_info +="Error: 9 " + notimeout_list[list_ind].blklist[j] + " can not be put on the top of the list!"+"\n";
      erorr_num++;
    }
  }
  return erorr_num;
  ...
  if (branch_end == notimeout_list[list_ind].blklist.length - 2) //branch在最后
  {
    ...
    for (var i = branch_begin; i <= branch_end; i++) {
      ...
      if (temp_type_name == "4") {
        ...
        complie_info +="Error: 10 " + notimeout_list[list_ind].blklist[i] + " can not be put at the bottom of the list!"+"\n";
        erorr_num++;
      }
    }
  } else { //branch不在最后
    if (notimeout_list[list_ind].blklist[branch_begin].indexOf("controls_and") >= 0 || notimeout_list[list_ind].blklist[branch_begin].indexOf("controls_or") >= 0) {
      ...
      complie_info +="Error: 12 " + notimeout_list[list_ind].blklist[branch_begin] + " can not be put in the middle of the branch!"+"\n";
      erorr_num++;
    }
...
function check_for(blkname, list_ind) {
  ...
  if (for_end == notimeout_list[list_ind].blklist.length - 2) //for在最后
  {
    ...
    if (temp_type_name == "4" ) {
      ...
      complie_info +="Error: 13 " + notimeout_list[list_ind].blklist[for_end] + " can not be put at the bottom of the list!"+"\n";
      erorr_num++;
    }
...
function check_timeout(blkname, list_ind) {
  ...
  for (var i = timeout_begin; i <= timeout_end; i++) {
    if (blk_list[list_ind].blklist[i].indexOf("controls_repeat_for") >= 0) {
      ...
      //i在and_statement处
      complie_info +="Error: controls_and can not be put in the timeout!"+"\n";
      erorr_num++;
      ...
      //i在or_statement处
      complie_info +="Error: controls_or can not be put in the timeout!"+"\n";
      erorr_num++;
      ...
      if (timeout_begin == i || blk_list[list_ind].blklist[timeout_end].indexOf("branch_statement") >= 0) {
        complie_info +="Error: controls_branch can not be put in begin or end of the timeout!"+"\n";
        erorr_num++;
      }
      var name_split = blk_list[list_ind].blklist[i].split("ID");
  ...
  for (var i = 0; i < blk_list[list_ind].blklist.length; i++) {
    if (blk_list[list_ind].blklist[i].indexOf("controls_repeat_for") >= 0) {
      ...
      if ((c_and_begin < timeout_begin) && (c_and_end > timeout_end)) {
        complie_info +="Error: timeout can not be put in the controls_and!"+"\n";
        erorr_num++;
      }
      ...
      if ((c_or_begin < timeout_begin) && (c_or_end > timeout_end)) {
        complie_info +="Error: timeout  can not be put in the controls_or!"+"\n";
        erorr_num++;
      }
